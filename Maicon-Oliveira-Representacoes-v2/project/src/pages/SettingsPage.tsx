  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-12 h-12 bg-orange-600 text-white rounded-2xl flex items-center justify-center shadow-md shadow-orange-200">
          <Settings size={22} />
        </div>
        <div>
          <h1 className="text-2xl font-black text-neutral-900 tracking-tight">Configurações</h1>
          <p className="text-neutral-500 text-sm">Gerencie as preferências do aplicativo</p>
        </div>
      </div>
